...
class CarSerializer(serializers.Serializer):
    ...
    manufacturer = serializers.CharField(max_length=64, read_only=True)
    model = serializers.CharField(max_length=64, read_only=True)
    horse_powers = serializers.IntegerField(read_only=True)
